...
export const CATEGORIES: Record<CategoryKey, CategoryMeta> = {
  grocery: {
    ...
    osm: ['"shop"~"^(supermarket|convenience|grocery|greengrocer|general|kiosk|variety_store|department_store|mall|wholesale)$"', '"amenity"="marketplace"'],
  ...
  pharmacy: {
    ...
    osm: ['"amenity"="pharmacy"', '"shop"~"^(chemist|medical_supply)$"', '"healthcare"="pharmacy"'],
  ...
  cafe: {
    ...
    icon: "cup",
    hint: "Coffee & tea",
    osm: ['"amenity"="cafe"', '"shop"~"^(coffee|tea|bakery|pastry)$"'],
  ...
  hardware: {
    ...
    icon: "wrench",
    hint: "DIY & tools",
    osm: ['"shop"~"^(hardware|doityourself|trade|paint|electrical|building_materials|tool_hire)$"'],
  ...
  post: {
    ...
    icon: "mail",
    hint: "Mail & shipping",
    osm: ['"amenity"~"^(post_office|post_depot)$"'],
    google: ["post_office"],
  },
  atm: {
    label: "ATM / Bank",
    icon: "card",
    hint: "Cash & banking",
    osm: ['"amenity"~"^(atm|bank|bureau_de_change)$"'],
    google: ["atm", "bank"],
  },
  gym: {
    label: "Gym",
    icon: "dumbbell",
    hint: "Fitness & sport",
    osm: ['"leisure"~"^(fitness_centre|sports_centre|fitness_station)$"', '"amenity"="gym"'],
